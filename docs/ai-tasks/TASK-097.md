# TASK-097 — Create Octopus import and TOU tariff guides
...
| Suggested commit | `task-097: create-octopus-import-and-tou-tariff-guides` |

## Complete prompt

You are Qwen3.6-27B acting as the senior engineer for the FlexSavvy repository.

Execute **TASK-097 only**. Do not start another task.

### Objective

Explain supported data and pricing modes.
...
1. Create Octopus JSON/CSV import guide limited to implemented paths
2. Create flat/TOU/dynamic explanation
3. Explain replay versus projection, missing prices and eligibility
4. Link methodology/simulator

### Explicit exclusions

- Do not request API keys or claim whole-market coverage

### Required verification

- Validate examples against schemas/resolvers
...
- the TASK-097 row in `docs/AI_TASK_INDEX.md` is changed from `TODO` to `DONE`;
