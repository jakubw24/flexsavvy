# TASK-111 — Create safe sample data and demo mode
...
| Suggested commit | `task-111: create-safe-sample-data-and-demo-mode` |

## Complete prompt

You are Qwen3.6-27B acting as the senior engineer for the FlexSavvy repository.

Execute **TASK-111 only**. Do not start another task.

### Objective

Let visitors use the full product without private data.
...
1. Create synthetic simple/flexible household data
2. Document independent expected results
3. Use normal importer/engines for Try sample
4. Label fictional figures
5. Use no real identifiers
6. Include sample tariffs

### Explicit exclusions

- Do not present sample savings as typical or use private data

### Required verification

- Run complete sample journeys and compare expected results
...
- the TASK-111 row in `docs/AI_TASK_INDEX.md` is changed from `TODO` to `DONE`;
