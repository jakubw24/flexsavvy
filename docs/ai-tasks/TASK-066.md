# TASK-066 — Implement carbon adapter contract and fixtures
...
| Suggested commit | `task-066: implement-carbon-adapter-contract-and-fixtures` |

## Complete prompt

You are Qwen3.6-27B acting as the senior engineer for the FlexSavvy repository.

Execute **TASK-066 only**. Do not start another task.

### Objective

Create an optional public-data boundary.
...
1. Define region, interval intensity, retrieval metadata and errors
2. Create sanitized typed fixtures
3. Mock tests
4. Do not require postcode
5. Keep monetary engine independent

### Explicit exclusions

- Do not fetch live or calculate emissions

### Required verification

- Test fixture parsing, unavailable adapter and malformed response
...
- the TASK-066 row in `docs/AI_TASK_INDEX.md` is changed from `TODO` to `DONE`;
