# TASK-087 — Implement printable HTML report
...
| Suggested commit | `task-087: implement-printable-html-report` |

## Complete prompt

You are Qwen3.6-27B acting as the senior engineer for the FlexSavvy repository.

Execute **TASK-087 only**. Do not start another task.

### Objective

Create a complete print-mode report.
...
1. Include summary, decomposition, tariff table, schedules, charts/text, confidence, assumptions, warnings and methodology
2. Hide controls
3. Prevent clipped content
4. Exclude raw intervals by default
5. Include timestamp/disclaimer

### Explicit exclusions

- Do not add paywall or external assets

### Required verification

- Test print-mode semantics, long tables and page layout where possible
...
- the TASK-087 row in `docs/AI_TASK_INDEX.md` is changed from `TODO` to `DONE`;
