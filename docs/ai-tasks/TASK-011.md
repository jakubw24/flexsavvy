# TASK-011 — Configure Vitest and Playwright
...
| Suggested commit | `task-011: configure-vitest-and-playwright` |

## Complete prompt

You are Qwen3.6-27B acting as the senior engineer for the FlexSavvy repository.

Execute **TASK-011 only**. Do not start another task.

### Objective

Establish offline unit and browser testing.
...
1. Configure Vitest for domain modules
2. Configure Playwright against production-like preview
3. Create landing and simulator smoke tests
4. Create fixture/test-helper directories
5. Ensure tests need no internet

### Explicit exclusions

- Do not add detailed feature tests

### Required verification

- Prove unit and browser smoke tests pass
- Verify clear failure when preview cannot start
...
- the TASK-011 row in `docs/AI_TASK_INDEX.md` is changed from `TODO` to `DONE`;
