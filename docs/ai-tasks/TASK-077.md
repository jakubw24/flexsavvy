# TASK-077 — Build EV and battery configuration steps
...
| Risk | critical |
| Network policy | `none` |
| Dependencies | TASK-057, TASK-065, TASK-071, TASK-072 |
| Suggested commit | `task-077: build-ev-and-battery-configuration-steps` |

## Complete prompt

You are Qwen3.6-27B acting as the senior engineer for the FlexSavvy repository.

Execute **TASK-077 only**. Do not start another task.

### Objective

Configure optional validated EV and battery scenarios.
...
1. Support EV disabled/future/shift
2. Capture energy method, charger, efficiency, windows, days and current profile
3. Support battery disabled/configured
4. Capture physical, policy, degradation and investment inputs
5. Show warnings
6. Use schema errors

### Explicit exclusions

- Do not run full simulation or infer equipment

### Required verification

- Test all modes, invalid efficiency/reserve, insufficient window preview and reset
...
- the TASK-077 row in `docs/AI_TASK_INDEX.md` is changed from `TODO` to `DONE`;
