# TASK-058 — Implement battery constraints and SOC discretisation
...
| Suggested commit | `task-058: implement-battery-constraints-and-soc-discretisation` |

## Complete prompt

You are Qwen3.6-27B acting as the senior engineer for the FlexSavvy repository.

Execute **TASK-058 only**. Do not start another task.

### Objective

Create a finite valid battery state space.
...
1. Calculate usable capacity/reserve
2. Use 0.25 kWh SOC increments
3. Map initial SOC by documented rule
4. Validate powers/efficiencies
5. Enumerate valid states
6. Reject impossible configs

### Explicit exclusions

- Do not generate actions or optimize

### Required verification

- Test capacity/reserve boundaries, rounding, tiny battery and invalid power
...
- the TASK-058 row in `docs/AI_TASK_INDEX.md` is changed from `TODO` to `DONE`;
