# TASK-031 — Implement statistics and extreme-value warnings
...
| Suggested commit | `task-031: implement-statistics-and-extreme-value-warnings` |

## Complete prompt

You are Qwen3.6-27B acting as the senior engineer for the FlexSavvy repository.

Execute **TASK-031 only**. Do not start another task.

### Objective

Calculate metrics and flag suspicious values without deleting them.
...
1. Calculate total import/export, average complete-day import, maximum interval and longest zero run
2. Flag >50 kWh/half-hour, zero >7 days, daily >200 kWh and abrupt tenfold increase
3. Centralize thresholds
4. Return evidence
5. Do not mutate data

### Explicit exclusions

- Do not correct anomalies
- Do not annualize

### Required verification

- Test each threshold and exact boundary, short datasets and export anomalies
...
- the TASK-031 row in `docs/AI_TASK_INDEX.md` is changed from `TODO` to `DONE`;
