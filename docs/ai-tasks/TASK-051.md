# TASK-051 — Add editable templates, UI and results
...
| Suggested commit | `task-051: add-editable-templates-ui-and-results` |

## Complete prompt

You are Qwen3.6-27B acting as the senior engineer for the FlexSavvy repository.

Execute **TASK-051 only**. Do not start another task.

### Objective

Expose useful assumptions and actionable output.
...
1. Add editable dishwasher, washing-machine and tumble-dryer templates
2. Return current/optimized cost, saving per cycle, observed-period saving, chosen start, alternatives and assumptions
3. Gate annual equivalents
4. Build accessible configuration UI
5. Support multiple appliances

### Explicit exclusions

- Do not claim measured specifications
- Do not persist by default

### Required verification

- Test editing, custom values, low confidence and multiple appliances
...
- the TASK-051 row in `docs/AI_TASK_INDEX.md` is changed from `TODO` to `DONE`;
