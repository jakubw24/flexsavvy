# TASK-057 — Complete EV outputs, UI and audit
...
| Risk | critical |
| Network policy | `none` |
| Dependencies | TASK-053, TASK-054, TASK-055, TASK-056 |
| Suggested commit | `task-057: complete-ev-outputs-ui-and-audit` |

## Complete prompt

You are Qwen3.6-27B acting as the senior engineer for the FlexSavvy repository.

Execute **TASK-057 only**. Do not start another task.

### Objective

Expose schedules and prove allocation correctness.
...
1. Return session schedules, observed/permitted annual cost, unmet energy, peak and carbon effects
2. Build accessible EV form
3. Add brute-force/invariant tests
4. Audit overnight, insufficient, negative prices and DST
5. Apply confidence/projection labels

### Explicit exclusions

- Do not integrate battery
- Do not persist schedules

### Required verification

- Run full unit and Playwright EV scenarios
...
- the TASK-057 row in `docs/AI_TASK_INDEX.md` is changed from `TODO` to `DONE`;
