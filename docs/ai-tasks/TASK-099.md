# TASK-099 — Create privacy and methodology guides; audit content
...
| Risk | high |
| Network policy | `none` |
| Dependencies | TASK-095, TASK-096, TASK-097, TASK-098 |
| Suggested commit | `task-099: create-privacy-and-methodology-guides-audit-content` |

## Complete prompt

You are Qwen3.6-27B acting as the senior engineer for the FlexSavvy repository.

Execute **TASK-099 only**. Do not start another task.

### Objective

Complete initial content and remove unsupported claims.
...
1. Create what half-hourly data reveals page
2. Create plain-language savings methodology page
3. Audit duplication, claims, headings and links
4. Verify CTAs match capabilities
5. Remove fabricated figures/generic filler
6. Update sitemap

### Explicit exclusions

- Do not add extra pages or affiliate links

### Required verification

- Run link, metadata and static build checks
...
- the TASK-099 row in `docs/AI_TASK_INDEX.md` is changed from `TODO` to `DONE`;
