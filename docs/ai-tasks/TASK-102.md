# TASK-102 — Harden appliance and EV property tests
...
| Suggested commit | `task-102: harden-appliance-and-ev-property-tests` |

## Complete prompt

You are Qwen3.6-27B acting as the senior engineer for the FlexSavvy repository.

Execute **TASK-102 only**. Do not start another task.

### Objective

Prove energy conservation and allocation optimality.
...
1. Add appliance properties for energy, windows, finish, subtraction and optimum
2. Add EV properties for delivered+unmet, capacity, window membership, baseline and optimum
3. Compare small cases with brute force
4. Cover negative prices/DST

### Explicit exclusions

- Do not hide seeds or reduce iterations without justification

### Required verification

- Run fixed-seed properties and brute force
...
- the TASK-102 row in `docs/AI_TASK_INDEX.md` is changed from `TODO` to `DONE`;
