# TASK-069 — Implement emissions and transparent weighted scoring
...
| Suggested commit | `task-069: implement-emissions-and-transparent-weighted-scoring` |

## Complete prompt

You are Qwen3.6-27B acting as the senior engineer for the FlexSavvy repository.

Execute **TASK-069 only**. Do not start another task.

### Objective

Calculate import emissions and optional cost-carbon decisions.
...
1. Calculate interval/total import emissions
2. Do not credit export in headline
3. Report export separately
4. Implement cost-only and weighted modes
5. Normalize components by documented ranges
6. Expose weights and component scores
7. Do not alter monetary totals

### Explicit exclusions

- Do not claim lifecycle emissions
- Do not hide weights

### Required verification

- Test zero import, export, missing carbon, equal cost and weight extremes
...
- the TASK-069 row in `docs/AI_TASK_INDEX.md` is changed from `TODO` to `DONE`;
