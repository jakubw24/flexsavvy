# TASK-098 — Create EV charging and battery-value guides
...
| Suggested commit | `task-098: create-ev-charging-and-battery-value-guides` |

## Complete prompt

You are Qwen3.6-27B acting as the senior engineer for the FlexSavvy repository.

Execute **TASK-098 only**. Do not start another task.

### Objective

Explain hardware modelling and limitations.
...
1. Create EV cost guide using mileage, efficiency, charger and windows
2. Create battery value guide covering efficiencies, reserve, degradation, grid charging, export and price uncertainty
3. Explain aggregate data cannot identify EV
4. Explain payback gates
5. Link simulator

### Explicit exclusions

- Do not promise savings or recommend brands

### Required verification

- Validate worked examples independently
...
- the TASK-098 row in `docs/AI_TASK_INDEX.md` is changed from `TODO` to `DONE`;
