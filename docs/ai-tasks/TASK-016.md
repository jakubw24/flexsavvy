# TASK-016 — Implement tariff and pricing schemas
...
| Suggested commit | `task-016: implement-tariff-and-pricing-schemas` |

## Complete prompt

You are Qwen3.6-27B acting as the senior engineer for the FlexSavvy repository.

Execute **TASK-016 only**. Do not start another task.

### Objective

Validate flat, TOU and interval tariff definitions.
...
1. Implement discriminated flat, TOU and interval pricing
2. Implement import and optional export pricing
3. Implement validity, region, source metadata, VAT-inclusive standing charge and eligibility
4. Validate local times and interval timestamps
5. Preserve permitted negative interval prices
6. Reject ambiguous objects

### Explicit exclusions

- Do not resolve rates or fetch catalogues

### Required verification

- Test all pricing types, negative interval rates, invalid charges, invalid periods and eligibility
...
- the TASK-016 row in `docs/AI_TASK_INDEX.md` is changed from `TODO` to `DONE`;
