# TASK-108 — Create deployment scripts and header configs

| Field | Value |
|---|---|
| Phase | 18 — Production deployment |
| Parent milestone | Milestone 20 |
| Risk | high |
| Network policy | `none` |
| Dependencies | TASK-093, TASK-107 |
| Suggested commit | `task-108: create-deployment-scripts-and-header-configs` |

## Complete prompt

You are Qwen3.6-27B acting as the senior engineer for the FlexSavvy repository.

Execute **TASK-108 only**. Do not start another task.

### Objective

Provide reproducible static deployment artifacts.
...
1. Create/update `docs/DEPLOYMENT.md`
2. Document clean validation/build
3. Provide nginx/Apache headers/cache and Cloudflare notes
4. Create optional dist package/checksum script
5. Embed no credentials
6. Document endpoint configuration

### Explicit exclusions

- Do not upload or modify live server

### Required verification

- Test packaging and validate examples where possible
...
- the TASK-108 row in `docs/AI_TASK_INDEX.md` is changed from `TODO` to `DONE`;
